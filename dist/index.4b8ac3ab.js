var e=globalThis,t={},n={},a=e.parcelRequire94c2;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in n){var a=n[e];delete n[e];var r={id:e,exports:{}};return t[e]=r,a.call(r.exports,r,r.exports),r.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},e.parcelRequire94c2=a),(0,a.register)("gFScX",function(e,t){Object.defineProperty(e.exports,"default",{get:()=>n,set:void 0,enumerable:!0,configurable:!0});var n={init(){this.pageContent=document.getElementById("page-content"),this.surahDetails=document.getElementById("surah-details"),this.pageNumberElement=document.getElementById("page-number"),this.prevButton=document.getElementById("prev"),this.nextButton=document.getElementById("next"),this.pageInput=document.getElementById("page-input"),this.currentPage=1,this.updatePage()},async updatePage(){this.pageContent.innerHTML="Loading...",this.surahDetails.innerHTML="";let e=await QuranController.getQuranPageData(this.currentPage);this.pageContent.innerHTML=e,this.pageNumberElement.textContent=`Page ${this.currentPage}`,this.prevButton.disabled=1===this.currentPage,this.nextButton.disabled=this.currentPage===QuranModel.maxPages},displaySurahDetails(e,t,n){e&&(this.surahDetails.innerHTML=`
    <table>
...
//# sourceMappingURL=index.4b8ac3ab.js.map
